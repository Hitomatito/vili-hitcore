deps_config := \
	...
	drivers/input/fingerprint/goodix_tee/Kconfig \
	...
	drivers/input/touchscreen/gt9916/Kconfig \
	drivers/input/touchscreen/fts_dual/xiaomi/Kconfig \
	drivers/input/touchscreen/fts_dual/Kconfig \
	drivers/input/touchscreen/fts_spi/Kconfig \
	drivers/input/touchscreen/focaltech_3680/Kconfig \
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu -fintegrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "Android (11967740, +pgo, +bolt, +lto, +mlgo, based on r522817) clang version 18.0.1 (https://android.googlesource.com/toolchain/llvm-project d8003a456d14a3deb8054cdaa529ffbf02d9b262)"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "llvm-nm"
include/config/auto.conf: FORCE
